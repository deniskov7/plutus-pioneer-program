...
mkValidator () r _ = traceIfFalse "flag1 does not match flag2, fail" $ flag1 r == flag2 r -- FIXED!
...
inst = Scripts.validator @Typed
   ...
   where
    wrap = Scripts.wrapValidator @() @MyRedeemer -- FIXED!

validator :: Validator
validator = Scripts.validatorScript inst -- FIXED!

valHash :: Ledger.ValidatorHash
valHash = Scripts.validatorHash validator -- FIXED!

scrAddress :: Ledger.Address
scrAddress = ScriptAddress valHash -- FIXED!
